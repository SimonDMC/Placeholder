...
# general close
execute as @a if predicate simondmc:lvl4/door_close if score tp 4 matches 1 run tp @e[type=item,tag=!paper] @s
execute as @a if predicate simondmc:lvl4/door_close if score global multiplayer matches 2.. if score tp 4 matches 1 run tp @a @s
execute as @a if predicate simondmc:lvl4/door_close if score global multiplayer matches 2.. run scoreboard players reset tp 4
...
# 4-1 close
execute as @a if predicate simondmc:lvl4/door_close run setblock -995 100 -998 redstone_block
...
# 4-2 close
execute as @a if predicate simondmc:lvl4/door_close run setblock -999 106 -1004 redstone_block
...
# 4-3 close
execute as @a if predicate simondmc:lvl4/door_close run setblock -1004 112 -999 redstone_block
...
# 4-4 close
execute as @a if predicate simondmc:lvl4/door_close run setblock -999 118 -994 redstone_block
...
# 4-5 close
execute as @a if predicate simondmc:lvl4/door_close run setblock -994 124 -999 redstone_block
...
# 4-6 close
execute as @a if predicate simondmc:lvl4/door_close run setblock -999 130 -1004 redstone_block
