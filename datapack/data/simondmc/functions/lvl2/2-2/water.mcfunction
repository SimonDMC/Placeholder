...
execute if score global water_timer matches 10 run playsound minecraft:block.fire.extinguish master @a[tag=started] 26 105 55 1 1.5
...
execute if score global2 water_timer matches 10 run playsound minecraft:block.fire.extinguish master @a[tag=started] 27 105 56 1 1.5
...
execute as @a[tag=started,x=25,y=106,z=55,dy=1] unless block 26 105 55 gray_concrete positioned 24.55 105.00 60.02 run playsound entity.villager.no master @a[tag=started]
execute as @a[tag=started,x=25,y=106,z=55,dy=1] unless block 26 105 55 gray_concrete run tp @s 24.55 105.00 60.02 -155.83 11.74