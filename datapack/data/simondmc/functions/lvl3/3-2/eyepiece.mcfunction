...
execute if block 1017 98 1029 iron_block if score helmet eyepiece matches 1 as @a[tag=started,nbt={SelectedItem:{tag:{SlowFall:1b}}}] run setblock 1013 96 1030 air
execute if block 1017 98 1029 iron_block if score helmet eyepiece matches 1 as @a[tag=started,nbt={SelectedItem:{tag:{SlowFall:1b}}}] run setblock 1012 95 1031 air
...
# keep in place when blocked by barrier
tp @e[tag=eyepiece,limit=1] 1013 96 1030
data merge entity @e[tag=eyepiece,limit=1] {Motion:[0.0,0.0,0.0]}