...
execute as @a[tag=started] if score @s clicked matches 1.. as @s[nbt={SelectedItem:{id:"minecraft:charcoal"}}] run function simondmc:lvl1/add_coal
...
execute as @a[tag=started] if predicate simondmc:lvl1/in_pit unless score in_pit crane matches 1 run scoreboard players set id narrator 2
execute as @a[tag=started] if predicate simondmc:lvl1/in_pit run scoreboard players set in_pit crane 1