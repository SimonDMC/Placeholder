...
execute if block -990 104 -997 wall_torch unless block -990 103 -996 air unless score snow 4 matches 1 run tag @a[nbt={Inventory:[{id:"minecraft:filled_map"}]}] add hasmap
...
execute if block -991 104 -996 wall_torch unless block -990 103 -996 air unless score snow 4 matches 1 run tag @a[nbt={Inventory:[{id:"minecraft:filled_map"}]}] add hasmap
...
execute if block -990 104 -996 wall_torch unless block -990 103 -996 air unless score snow 4 matches 1 run tag @a[nbt={Inventory:[{id:"minecraft:filled_map"}]}] add hasmap
...
execute if block -992 103 -996 wall_torch unless block -990 103 -996 air unless score snow 4 matches 1 run tag @a[nbt={Inventory:[{id:"minecraft:filled_map"}]}] add hasmap
