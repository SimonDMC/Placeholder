...
execute as @a if score @s walkthrough matches 1.. run tellraw @s {"text":"youtu.be/iSnyGt-uduc","bold":true,"color":"yellow","clickEvent":{"action":"open_url","value":"https://youtu.be/iSnyGt-uduc"}}
...
execute as @a if score @s bug matches 1.. run tellraw @s {"text":"Click here to submit bug report.","color":"yellow","clickEvent":{"action":"open_url","value":"https://simondmc.com/placeholder/bug-report"}}
