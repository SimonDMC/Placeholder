...
execute unless block -999 132 -1010 air as @a[tag=started] at @s run playsound entity.experience_orb.pickup master @s
execute unless block -999 132 -1010 air run clear @a[tag=started] end_rod
