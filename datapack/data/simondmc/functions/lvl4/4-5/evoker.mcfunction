...
execute as @a[tag=started] if predicate simondmc:lvl4/evoker run effect give @s weakness 4 4 true
execute as @a[tag=started] unless predicate simondmc:lvl4/evoker run effect clear @s weakness

# tnt
execute if entity @a[tag=started,predicate=simondmc:lvl4/evoker] run data modify entity @e[type=tnt,limit=1] Motion[0] set value 0.0000
...
execute if entity @e[type=tnt] as @a[tag=started,nbt={SelectedItem:{id:"minecraft:flint_and_steel",Count:1b,tag:{Damage:34}}}] at @s run playsound entity.item.break master @s
execute if entity @e[type=tnt] as @a[tag=started,nbt={SelectedItem:{id:"minecraft:flint_and_steel",Count:1b,tag:{Damage:34}}}] run clear @a[tag=started] flint_and_steel
execute if entity @e[type=tnt] as @a[tag=started,nbt={SelectedItem:{id:"minecraft:flint_and_steel",Count:1b,tag:{Damage:0}}}] run item replace entity @s weapon.mainhand with flint_and_steel{CanPlaceOn:["minecraft:yellow_concrete","minecraft:tnt"],HideFlags:4,Damage:33}
...
execute if block -989 126 -999 fire as @a[tag=started,nbt={SelectedItem:{id:"minecraft:flint_and_steel",Count:1b,tag:{Damage:34}}}] at @s run playsound entity.item.break master @s
execute if block -989 126 -999 fire as @a[tag=started,nbt={SelectedItem:{id:"minecraft:flint_and_steel",Count:1b,tag:{Damage:34}}}] run clear @a[tag=started] flint_and_steel
execute if block -989 126 -999 fire as @a[tag=started,nbt={SelectedItem:{id:"minecraft:flint_and_steel",Count:1b,tag:{Damage:0}}}] run item replace entity @s weapon.mainhand with flint_and_steel{CanPlaceOn:["minecraft:yellow_concrete","minecraft:tnt"],HideFlags:4,Damage:33}
...
# stop jump
execute as @a[tag=started] if predicate simondmc:lvl4/evoker run effect clear @s jump_boost
execute as @a[tag=started] if predicate simondmc:lvl4/evoker run scoreboard players reset jump 4

# dynamic silence
execute as @a[tag=started] if predicate simondmc:lvl4/evoker as @e[tag=evoker] run data merge entity @s {Silent:0b}
execute as @a[tag=started] unless predicate simondmc:lvl4/evoker as @e[tag=evoker] run data merge entity @s {Silent:1b}

# campfire
execute if entity @a[tag=started,nbt={SelectedItem:{id:"minecraft:campfire"}}] run tp @e[tag=campfire1] -988.8 126 -998.2
execute if entity @a[tag=started,nbt={SelectedItem:{id:"minecraft:campfire"}}] run tp @e[tag=campfire2] -988.8 126 -998.8
execute unless entity @a[tag=started,nbt={SelectedItem:{id:"minecraft:campfire"}}] run tp @e[tag=campfire1] -1000 83 -1000
execute unless entity @a[tag=started,nbt={SelectedItem:{id:"minecraft:campfire"}}] run tp @e[tag=campfire2] -1000 83 -1000
execute as @a[tag=started] if score @s clicked matches 1.. as @s[nbt={SelectedItem:{id:"minecraft:campfire"}}] if block -989 125 -999 coal_block run scoreboard players set t_campfire 4 1
execute if score t_campfire 4 matches 1 run scoreboard players add campfire 4 1
execute if score campfire 4 matches 1 run clear @a[tag=started] campfire
...
execute as @a[tag=started] if predicate simondmc:lvl4/evoker run scoreboard players reset @a[tag=started] clicked
...
# tp in
execute if score global multiplayer matches 2.. as @a[tag=started,x=-994,y=126,z=-999,dy=1] unless score tp5 4 matches 1 run tp @a[tag=started] @s
execute if score global multiplayer matches 2.. as @a[tag=started,x=-994,y=126,z=-999,dy=1] run scoreboard players set tp5 4 1