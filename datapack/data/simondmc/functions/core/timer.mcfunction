...
# lvl1 playtime
execute if entity @a[tag=lvl1] run scoreboard players add lvl1_t timer 1
...
# lvl2 playtime
execute if entity @a[tag=lvl2] run scoreboard players add lvl2_t timer 1
...
# lvl3 playtime
execute if entity @a[tag=lvl3] run scoreboard players add lvl3_t timer 1
...
# lvl4 playtime
execute if entity @a[tag=lvl4] run scoreboard players add lvl4_t timer 1
