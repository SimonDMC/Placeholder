...
# opening (multiplayer)
execute if score global multiplayer matches 2.. unless score global copper_pressed matches 1..2 unless entity @a[tag=started,x=41,y=108,z=41,distance=1..] as @a at @s run playsound minecraft:block.chain.break master @s
execute if score global multiplayer matches 2.. unless score global copper_pressed matches 1..2 unless entity @a[tag=started,x=41,y=108,z=41,distance=1..] as @a at @s run playsound minecraft:block.chain.place master @s
execute if score global multiplayer matches 2.. unless score global copper_pressed matches 1..2 unless entity @a[tag=started,x=41,y=108,z=41,distance=1..] as @a at @s run playsound minecraft:block.piston.extend master @s ~ ~ ~ 0.5
execute if score global multiplayer matches 2.. unless score global copper_pressed matches 1..2 unless entity @a[tag=started,x=41,y=108,z=41,distance=1..] run title @a actionbar "§a<Door Opened>"
...
# closing (multiplayer)
execute if score global multiplayer matches 2.. if score global copper_pressed matches 1 if entity @a[tag=started,x=41,y=108,z=41,distance=1..] as @a at @s run playsound minecraft:block.chain.break master @s
execute if score global multiplayer matches 2.. if score global copper_pressed matches 1 if entity @a[tag=started,x=41,y=108,z=41,distance=1..] as @a at @s run playsound minecraft:block.chain.place master @s
execute if score global multiplayer matches 2.. if score global copper_pressed matches 1 if entity @a[tag=started,x=41,y=108,z=41,distance=1..] as @a at @s run playsound minecraft:block.piston.contract master @s ~ ~ ~ 0.5
execute if score global multiplayer matches 2.. if score global copper_pressed matches 1 if entity @a[tag=started,x=41,y=108,z=41,distance=1..] run title @a actionbar "§c<Door Closed>"
