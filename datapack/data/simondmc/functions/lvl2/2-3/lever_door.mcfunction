...
execute unless score locked lever matches 1 unless score open lever matches 1 as @a if block 38 105 35 cracked_stone_bricks if predicate simondmc:lvl2/lever_lock run scoreboard players set id narrator 8
execute unless score locked lever matches 1 unless score open lever matches 1 as @a if block 38 105 35 cracked_stone_bricks if predicate simondmc:lvl2/lever_lock run scoreboard players set locked lever 1

# stop from cheating
execute as @a[gamemode=!adventure] if predicate simondmc:lvl2/lever_lock run tellraw @s "§cNope! Figure it out yourself :)"
execute as @a[gamemode=!adventure] if predicate simondmc:lvl2/lever_lock run gamemode adventure @s