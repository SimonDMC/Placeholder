...
execute if block -999 109 -1006 tnt run playsound entity.tnt.primed master @a[tag=started] -999 109 -1006
...
execute if block -1000 109 -1007 tnt run playsound entity.tnt.primed master @a[tag=started] -1000 109 -1007
...
execute if block -999 109 -1008 tnt run playsound entity.tnt.primed master @a[tag=started] -999 109 -1008
...
execute if block -998 109 -1007 tnt run playsound entity.tnt.primed master @a[tag=started] -998 109 -1007
...
execute if block -999 110 -1007 tnt run playsound entity.tnt.primed master @a[tag=started] -999 110 -1007
...
execute as @e[type=end_crystal,x=-999,y=110,z=-1007,distance=..1] at @s run playsound entity.generic.explode master @a[tag=started] ~ ~ ~ 1.5
...
execute if block -999 109 -1006 respawn_anchor[charges=1] run playsound entity.generic.explode master @a[tag=started] -999 109 -1006 1.5
...
execute if block -1000 109 -1007 respawn_anchor[charges=1] run playsound entity.generic.explode master @a[tag=started] -1000 109 -1007 1.5
...
execute if block -999 109 -1008 respawn_anchor[charges=1] run playsound entity.generic.explode master @a[tag=started] -999 109 -1008 1.5
...
execute if block -998 109 -1007 respawn_anchor[charges=1] run playsound entity.generic.explode master @a[tag=started] -998 109 -1007 1.5
...
execute if block -999 110 -1007 respawn_anchor[charges=1] run playsound entity.generic.explode master @a[tag=started] -999 110 -1007 1.5
...
execute if block -999 109 -1006 fire run playsound entity.generic.explode master @a[tag=started] -999 109 -1006 1.5
...
execute if block -1000 109 -1007 fire run playsound entity.generic.explode master @a[tag=started] -1000 109 -1007 1.5
...
execute if block -999 109 -1008 fire run playsound entity.generic.explode master @a[tag=started] -999 109 -1008 1.5
...
execute if block -998 109 -1007 fire run playsound entity.generic.explode master @a[tag=started] -998 109 -1007 1.5
...
execute if block -999 110 -1007 fire run playsound entity.generic.explode master @a[tag=started] -999 110 -1007 1.5
