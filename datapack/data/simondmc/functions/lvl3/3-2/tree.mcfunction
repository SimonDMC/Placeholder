...
# entering
execute as @a[tag=started] if predicate simondmc:lvl3/tree_in if score global tree matches 1 run scoreboard players set @s tree -1
# narrator line
...
execute as @a[tag=started] if predicate simondmc:lvl3/tree_in if score global tree matches 1 run tp @a[tag=spec] @s

# exiting
execute as @a[tag=started] if predicate simondmc:lvl3/tree_out if score global tree matches 1 run scoreboard players reset @s tree
execute as @a[tag=started] if predicate simondmc:lvl3/tree_out if score global tree matches 1 at @s run tp @s ~45 ~17 ~-1
execute as @a[tag=started] if predicate simondmc:lvl3/tree_out if score global tree matches 1 run tp @a[tag=spec] @s
...
execute if score cutscene tree matches 22 run playsound entity.player.levelup master @a[tag=started]
