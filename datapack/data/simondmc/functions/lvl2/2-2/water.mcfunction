...
execute as @a[tag=started,x=25,y=106,z=55,dy=1] unless block 26 105 55 gray_concrete positioned 24.55 105.00 60.02 run playsound entity.villager.no master @a
