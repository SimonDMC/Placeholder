...
execute if score stats end matches 1 run scoreboard players enable @a morestats
execute if score stats end matches 1 as @a run tellraw @s ["",{"text":"Total Playtime: ","color":"yellow"},{"score":{"name":"h","objective":"timer"},"color":"green"},{"text":"h ","color":"green"},{"score":{"name":"m","objective":"timer"},"color":"green"},{"text":"m ","color":"green"},{"score":{"name":"s","objective":"timer"},"color":"green"},{"text":"s","color":"green"},{"text":"\n"},{"text":"Secrets Discovered: ","color":"yellow"},{"score":{"name":"@s","objective":"secrets"},"color":"green"},{"text":"/5","color":"green"},{"text":"\n"},{"text":"Hints Used: ","color":"yellow"},{"score":{"name":"@s","objective":"hints"},"color":"green"},{"text":"\n\n"},{"text":"Click for more stats","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger morestats"}}]
scoreboard players reset stats end

# stats villagers
execute as @a if score @s clicked matches 1.. run scoreboard players set stats end 1
scoreboard players reset @a clicked

# more stats
execute as @a if score @s morestats matches 1.. run tellraw @s ["",{"text":"Level 1 Playtime: ","color":"yellow"},{"score":{"name":"lvl1_m","objective":"timer"},"color":"green"},{"text":"m ","color":"green"},{"score":{"name":"lvl1_s","objective":"timer"},"color":"green"},{"text":"s","color":"green"},{"text":"\n"},{"text":"Level 2 Playtime: ","color":"yellow"},{"score":{"name":"lvl2_m","objective":"timer"},"color":"green"},{"text":"m ","color":"green"},{"score":{"name":"lvl2_s","objective":"timer"},"color":"green"},{"text":"s","color":"green"},{"text":"\n"},{"text":"Level 3 Playtime: ","color":"yellow"},{"score":{"name":"lvl4_m","objective":"timer"},"color":"green"},{"text":"m ","color":"green"},{"score":{"name":"lvl4_s","objective":"timer"},"color":"green"},{"text":"s","color":"green"},{"text":"\n"},{"text":"Level 4 Playtime: ","color":"yellow"},{"score":{"name":"lvl3_m","objective":"timer"},"color":"green"},{"text":"m ","color":"green"},{"score":{"name":"lvl3_s","objective":"timer"},"color":"green"},{"text":"s","color":"green"},{"text":"\n"},{"text":"Deaths: ","color":"yellow"},{"score":{"name":"@s","objective":"s_death"},"color":"green"}]
execute as @a if score @s morestats matches 1.. run scoreboard players reset @s morestats

# fill back wall with quartz once walked through
execute as @a[x=1090,y=101,z=1025,dx=2,dy=2,dz=6] if score global end matches 1 unless block 1088 101 1029 smooth_quartz if score global multiplayer matches 2.. run tp @a @s
execute as @a[x=1090,y=101,z=1025,dx=2,dy=2,dz=6] if score global end matches 1 run fill 1088 101 1029 1088 103 1027 smooth_quartz
