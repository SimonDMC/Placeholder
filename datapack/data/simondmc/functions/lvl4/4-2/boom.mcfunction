...
execute as @a if score @s pearl matches 1 unless entity @e[type=ender_pearl,tag=!display] run fill -999 108 -1002 -999 109 -1002 barrier
execute as @a if score @s pearl matches 1 unless entity @e[type=ender_pearl,tag=!display] run scoreboard players set phase 4 1
...
execute as @a at @s if block ~ ~ ~ smooth_quartz if score phase 4 matches 1 run tp @s -998.5 108 -1003.5 180 0
execute as @a at @s if block ~ ~ ~ barrier if score phase 4 matches 1 run tp @s -998.5 108 -1003.5 180 0

# tnt explosion (some stuff is handled in evoker function already)
execute as @e[type=tnt,nbt={Fuse:1s}] if entity @a[predicate=simondmc:lvl4/explosion] run setblock -999 109 -1007 obsidian destroy
...
execute if score creeper 4 matches 1 run effect give @a resistance 3 5 true
execute if score creeper 4 matches 1 unless entity @e[type=creeper] run effect clear @a resistance
