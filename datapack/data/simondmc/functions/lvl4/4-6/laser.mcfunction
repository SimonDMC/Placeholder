...
execute if score laser 4 matches 1 unless entity @e[tag=rod] run stopsound @a master block.beacon.ambient
...
execute if score bAnim 4 matches 1 run clear @a shears
...
# crafting
execute as @a if score @s rod matches 1.. run clear @s dead_tube_coral_fan
execute as @a if score @s rod matches 1 run give @s end_rod{CanPlaceOn:["minecraft:quartz_bricks"],display:{Name:'{"text":"Laser End Rod","color":"red","italic":false}',Lore:['{"text":"Shoots a laser in the","color":"gray","italic":false}','{"text":"direction it\'s facing.","color":"gray","italic":false}']}} 1
execute as @a if score @s rod matches 2 run give @s end_rod{CanPlaceOn:["minecraft:quartz_bricks"],display:{Name:'{"text":"Laser End Rod","color":"red","italic":false}',Lore:['{"text":"Shoots a laser in the","color":"gray","italic":false}','{"text":"direction it\'s facing.","color":"gray","italic":false}']}} 2
execute as @a if score @s rod matches 3 run give @s end_rod{CanPlaceOn:["minecraft:quartz_bricks"],display:{Name:'{"text":"Laser End Rod","color":"red","italic":false}',Lore:['{"text":"Shoots a laser in the","color":"gray","italic":false}','{"text":"direction it\'s facing.","color":"gray","italic":false}']}} 3
execute as @a if score @s rod matches 4 run give @s end_rod{CanPlaceOn:["minecraft:quartz_bricks"],display:{Name:'{"text":"Laser End Rod","color":"red","italic":false}',Lore:['{"text":"Shoots a laser in the","color":"gray","italic":false}','{"text":"direction it\'s facing.","color":"gray","italic":false}']}} 4
execute as @a if score @s rod matches 5 run give @s end_rod{CanPlaceOn:["minecraft:quartz_bricks"],display:{Name:'{"text":"Laser End Rod","color":"red","italic":false}',Lore:['{"text":"Shoots a laser in the","color":"gray","italic":false}','{"text":"direction it\'s facing.","color":"gray","italic":false}']}} 5
execute as @a if score @s rod matches 6 run give @s end_rod{CanPlaceOn:["minecraft:quartz_bricks"],display:{Name:'{"text":"Laser End Rod","color":"red","italic":false}',Lore:['{"text":"Shoots a laser in the","color":"gray","italic":false}','{"text":"direction it\'s facing.","color":"gray","italic":false}']}} 6
execute as @a if score @s rod matches 1.. run scoreboard players reset @s rod