...
execute if score total 4_axe matches 5 unless score given 4_axe matches 5 as @a[tag=started] unless score @s 4_wart matches 1.. run item replace entity @s weapon.mainhand with iron_axe{CanDestroy:["minecraft:nether_wart"],HideFlags:2,Damage:210,Enchantments:[{id:"minecraft:efficiency",lvl:2s}]}
